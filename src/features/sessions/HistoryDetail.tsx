...
import { FOCUS_LABELS, type WorkoutRecord } from '../../domain';
    ...
    <Page title={record.planSnapshot.name} subtitle={`Historical record · ${formatLongDate(record.sessionDate)}`} backTo="/progress">
      <div className="history-detail">
        ...
        <section className="detail-section">
          <div className="section-heading"><div><p className="eyebrow">What you followed</p><h2>{record.planSnapshot.prescriptions.length} exercises</h2></div><span className="area-pill">{FOCUS_LABELS[focus]} focus</span></div>
